## four simulations are carried out, 200 replicates of each, sampling R0 from the credibility interval:  
## 1. duration of infection = 3 and initial infected =~ 200
## 2. duration of infection = 3 and initial infected =~ 2000
## 3. duration of infection = 7 and initial infected =~ 200
## 4. duration of infection = 7 and initial infected =~ 2000
...
covid_SDurInf3 = list() 
## median aggregate susceptible per day for the four different scenarios
...
covid_IDurInf3 = list() 
## median aggregate incidence per day for the four different scenarios
...
## Peak aggregate incidence per simulation and time of peak
...
## "median" simulation in each scenario (median based on last day)
covid_DurInf3 = list() 
...
## median incidence per day per age group for each of the scenarios
...
## Output of first simulation in each scenario
