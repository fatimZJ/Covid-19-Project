...
### Use R0 to get beta
getbeta_new <- function(R0t, pars, p_age, CONTACTMATRIX = contacts) {
...
### Use beta to get R0
getR0t_new <- function(beta, pars, constraints, p_age, calculate_transmission_probability = TRUE, CONTACTMATRIX = contacts) {
